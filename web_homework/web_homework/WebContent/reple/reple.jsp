...
<body>
<form action="datgeulsave.jsp" name="frm" method="post"> <!-- form태그는 post -->
...
<input type="hidden" name="nested" value="<%=dto.getStar()%>">
	<table border="1">
		<tr>
			<td colspan="2"><h2>댓글을 달아 올리는 페이지입니다.</h2></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center" height="30">
				...
				<input type="button" value="목  록"
				  onClick="location.href='replylist.jsp?page=<%=spage%>'"></td>
		</tr>
	</table>
</form>
</body>
