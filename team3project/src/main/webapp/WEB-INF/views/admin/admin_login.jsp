...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="resources/static/font/font-awesome-4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="resources/static/font/iconic/css/material-design-iconic-font.min.css">
	...
	<link rel="stylesheet" type="text/css" href="resources/static/css/adminmain.css">
</head>
<body>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="admin_login" method="post">
					...
					<span class="login100-form-title p-b-48">
						<a href="main"><img width="70" src="resources/static/images/mbook.png"></a>
					</span>
	...
	<script src="resources/static/js/adminmain.js"></script>
