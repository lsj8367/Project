...
<div id="container">
    ...
    <div id="content">
        ...
        <table class="newbooktable"
               style="text-align:center; width: 100%; margin: auto; float: left;">
        ...
        <table class="newbooktable" style="margin: auto; float: none; width: 100%">
            ...
            <tr>
                <c:choose>
                    ...
                    <c:otherwise>
                        <td colspan="2">${sessionScope.name}님 환영합니다.<br>보유포인트는 ${sessionScope.point}point
                        </td>
                    </c:otherwise>
                </c:choose>
            </tr>
