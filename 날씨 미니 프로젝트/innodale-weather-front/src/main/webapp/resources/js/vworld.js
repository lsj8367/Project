var vmap;
 ...
 //대구 
   ...
   vw.ol3.markerOption = {
	   ...
	   y : 37.8687948,
	   epsg : "EPSG:4326",
	   title : `${data[9].geoLocation.district}`,
   ...
   vw.ol3.markerOption = {
	   ...
	   y :  37.3499794,
	   epsg : "EPSG:4326",
	   title : `${data[10].geoLocation.district}`,
 ...
 //강릉
   vw.ol3.markerOption = {
	   ...
	   y :  37.7636948,
	   epsg : "EPSG:4326",
	   title : `${data[11].geoLocation.district}`,
   ...
   vw.ol3.markerOption = {
	   ...
	   y :  38.2046448,
	   epsg : "EPSG:4326",
	   title : `${data[12].geoLocation.district}`,
 ...
 //군산
   vw.ol3.markerOption = {
	   ...
	   y : 35.9658835,
	   epsg : "EPSG:4326",
	   title : `${data[13].geoLocation.district}`,
 ...
 //목포
   vw.ol3.markerOption = {
	   ...
	   y :  34.802795,
	   epsg : "EPSG:4326",
	   title : `${data[14].geoLocation.district}`,
   ...
   vw.ol3.markerOption = {
	   ...
	   y :  34.752495,
	   epsg : "EPSG:4326",
	   title : `${data[15].geoLocation.district}`,
   ...
   vw.ol3.markerOption = {
	   ...
	   y : 33.3769611,
	   epsg : "EPSG:4326",
	   title : `${data[16].geoLocation.city}`,
